"""
Django settings for networkcoverageapi project.
...
SECRET_KEY = 'django-insecure-$a6o#^wur5*s1b)g@7*_8jxui2+1e_3%e+4x70+k&cn8*c&!s)'
...
ROOT_URLCONF = 'networkcoverageapi.urls'
...
WSGI_APPLICATION = 'networkcoverageapi.wsgi.application'
